...
const ApsedecWebsite = () => {
  ...
  const impactStats = [
    { number: '26+', label: 'Member Organizations', icon: <Building className="w-6 h-6" /> },
    { number: '23+', label: 'Years of Impact', icon: <ChartArea className="w-6 h-6" /> },
    { number: '1000+', label: 'Projects Completed', icon: <Target className="w-6 h-6" /> },
    { number: '50k+', label: 'Lives Impacted', icon: <Users className="w-6 h-6" /> }
  ];

  const initiatives = [
    {
      title: 'Financial Inclusion',
      description: 'Expanding access to financial services and opportunities in rural communities',
      image: 'https://www.apsedec.com/img/5.png',
      category: 'Development'
    },
    {
      title: 'Agricultural Innovation',
      description: 'Modernizing farming practices and improving agricultural productivity',
      image: 'https://firebasestorage.googleapis.com/v0/b/apsedec-blogs.appspot.com/o/blogs%2FFJE7xuwZ7TVkpy1ovmvEGJRL1412%2F1723617936518_galleryImage_0?alt=media&token=1d03f5a0-e8e8-47b9-8ba6-460510876676',
      category: 'Agriculture'
    },
    {
      title: 'Youth Empowerment',
      description: 'Creating opportunities through skills development and training programs',
      image: 'https://www.apsedec.com/img/6.png',
      category: 'Education'
    }
  ];

  if (currentScreen === 'initiatives') {
    return <InitiativesScreen onNavigate={handleNavigation} />;
  }

  // If current screen is about, render AboutScreen
  ...
  if (currentScreen === 'impact') {
    return <ImpactScreen onNavigate={handleNavigation} />;
  }

  // If current screen is about, render AboutScreen
  if (currentScreen === 'partners') {
    return <PartnersScreen onNavigate={handleNavigation} />;
  }

  // If current screen is about, render AboutScreen
  if (currentScreen === 'contact') {
    return <ContactScreen onNavigate={handleNavigation} />;
  }
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {/* <button className="px-8 py-4 border border-gray-200 rounded-lg hover:border-green-800 hover:text-green-800 transition flex items-center justify-center space-x-2">
                  <Play size={20} />
